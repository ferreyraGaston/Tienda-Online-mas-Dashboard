...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="email" name="email" placeholder="Introduce tu correo electrónico" required class="box">
      ...
      <p>no tienes una cuenta? <a href="register.php">registrar Ahora</a></p>
   </form>
