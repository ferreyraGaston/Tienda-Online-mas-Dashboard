...
<section class="contact">
   ...
   <form action="" method="post">
      <h3>¡Di algo!</h3>
      <input type="text" name="name" required placeholder="introduzca su nombre" class="box">
      <input type="email" name="email" required placeholder="Introduce tu correo electrónico" class="box">
      <input type="number" name="number" required placeholder="introduzca tu numero" class="box">
